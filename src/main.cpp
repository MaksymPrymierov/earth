...
int main(int argc, char *argv[])
{
  ...
  window->addButton("Следующий год"); // id 3
  window->addButton("Выход");          // id 4
  ...
  QObject::connect(window->getButton(3), &QPushButton::clicked, world, &World::update);
  QObject::connect(window->getButton(4), &QPushButton::clicked, &a, &QApplication::quit);
